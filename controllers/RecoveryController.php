...
//        if (!$this->module->user->enablePasswordRecovery) {
        ...
        if ($model->load(\Yii::$app->request->post())) {
            if ($model->validate()) {
                ...
                if (isset($user) and $user !== NULL) {
                    ...
                    \Yii::$app->getSession()->setFlash('error', \Yii::t('user', 'There is no user with such email.'));
                }
            } else {
                \Yii::$app->getSession()->setFlash('error', \Yii::t('user', 'Email is not a valid email address.'));
            }
        }
