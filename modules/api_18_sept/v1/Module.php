...
class Module extends \yii\base\Module {
    ...
    public $api_urls = [
        ...
        'api/v1/calendar/detail',      //Done
		 'api/v1/calendar/searchcalandar',      //Done
	...
	public $webregistration_url = 'api/v1/user/webregistration';
    ...
    private function verifyandLogin() {
        ...
        }else if ($this->model_apilog->request_url == $this->webregistration_url) {// at the time of login app_id will be missing
            if ($this->model_apilog->imei_no == "") {
                throw new \yii\web\BadRequestHttpException("Bad Request, imei_no missing"); //error 400
            }
        }
