         ...
         if (isset($this->data_json['meeting_id']) && $this->data_json['meeting_id'] != '') { // Edit/update existing meeting
            ...
            if ($meeting_model == null) {
                throw new \yii\web\ForbiddenHttpException("Forbidden. Meeting Id not found.");
                 ...
                 print_r($meeting_model->reoccurring_type);
                if(isset($this->data_json['status']) && $this->data_json['status'] == 0 && $meeting_model->reoccurring_type !=1){
                     \app\models\Meeting::updateAll(['status' => 0], "meeting_reoccurring_id =" . $meeting_model->meeting_reoccurring_id);
                  //  $meeting_model =\app\models\Meeting::find()->where(['meeting_reoccurring_id	'=>$meeting_model->meeting_reoccurring_id,'status'=>1])->all();
                }
                die;
            ...
            if ($form_model->validate()) {
                ...
                $array1 = array();
                      ...
                      if(!empty($this->data_json['muser'])){    
                          ...
                          if (isset($this->data_json['created_by_behalf_of']) && $this->data_json['created_by_behalf_of'] != '') {
                                $form_model->created_by_behalf_of=$this->data_json['created_by_behalf_of'];
                            }
                        ...
                        //    print_r($form_model->created_by_behalf_of);die;
            ...
            if ($meeting_model == null) {
               ...
               // $meeting_user_model = \app\models\MeetingUser::findOne($this->data_json['meeting_user_id']);
                ...
                if ($meeting_user_model == null) {
                   ...
                   // print_r($this->data_json['meeting_id']);die;
